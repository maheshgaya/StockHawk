...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //when recycleview is empty
        mEmptyRecycleView = (TextView)findViewById(R.id.empty_recyclview);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isConnected) {
                    MaterialDialog materialDialog = new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                ...
                                public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if (c.getCount() != 0) {
                                        Toast toast =
                                                Toast.makeText(MyStocksActivity.this, getString(R.string.error_stock_already_saved),
                                                        Toast.LENGTH_LONG);
                            ...
                            }).backgroundColor(getResources().getColor(R.color.material_gray_800))
                            .show();
